...
hl.config({
    general = {
        ...
        allow_tearing = false, -- false by default
...
hl.bind(mainMod .. " + SHIFT + B     "   , hl.dsp.exec_cmd(browser_private))
...
hl.bind(mainMod .. "         + PERIOD"   , hl.dsp.exec_cmd("noctalia-shell ipc call controlCenter toggle"))
hl.bind(mainMod .. "         + W     "   , hl.dsp.exec_cmd("noctalia-shell ipc call wallpaper random all"))
